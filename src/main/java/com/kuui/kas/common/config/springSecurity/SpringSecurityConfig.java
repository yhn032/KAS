    ...
    public SecurityFilterChain exceptionSecurityFilterChain(HttpSecurity http) throws  Exception {
        http
                ...
                .and()
                    ...
                    .ignoringAntMatchers("/teacher/modifyTeacherInfo","/file/uploadImg","/asset/addList", "/teacher/addProfileImg","/teacher/duplicateId","/common/signup", "/loginProc", "/logout", "/asset/searchAsset", "/board/addShare", "/board/modifyShare", "/asset/modify");
